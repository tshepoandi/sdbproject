...
import {HeroWrapper,ContentWrapper,CallToActionButton,HeroImage,Title, TextColorBlue, TextColorWhite, Heading} from "./StyledComponents/styledHero"
...
const HeroPage = () => {
  return (
    <HeroWrapper>
      ...
      <ContentWrapper>
        <Heading>Sedibeng Training Center</Heading>
        <Title>
